module Facets.Slider.DoubleSlider exposing
    ( DoubleSlider
    , init
    , view
...
import Facets.Slider.RangeSlider as RangeSlider exposing (defaultStyles)
...
view (DoubleSlider slider) =
    div [ Html.Attributes.class "input-range-parent-container" ]
        [ VirtualDom.node "div"
            []
            [ VirtualDom.node "style" [] [ VirtualDom.text defaultStyles ] ]
        , div
