...
class Voice(models.Model):
    ...
    item = models.ForeignKey("diamm_data.Item", related_name="voices", on_delete=models.CASCADE)
    languages = models.ManyToManyField("diamm_data.Language")
    mensuration = models.ForeignKey("diamm_data.Mensuration", blank=True, null=True, on_delete=models.CASCADE)
    clef = models.ForeignKey("diamm_data.Clef", blank=True, null=True, on_delete=models.CASCADE)
    ...
    standard_text = models.ForeignKey("diamm_data.Text", blank=True, null=True, on_delete=models.CASCADE)
